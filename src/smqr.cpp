...
// [[Rcpp::export]]
Rcpp::List smqrGaussNsd(const arma::mat& X, const arma::vec& Y, const double tau = 0.5, const double constTau = 1.345, const double tol = 0.0000001, 
                        const int iteMax = 5000) {
  const int n = X.n_rows;
  const int p = X.n_cols;
  const double h = std::pow((std::log(n) + p) / n, 0.4);
...
// [[Rcpp::export]]
Rcpp::List smqrUnifNsd(const arma::mat& X, const arma::vec& Y, const double tau = 0.5, const double constTau = 1.345, const double tol = 0.0000001, 
                       const int iteMax = 5000) {
  const int n = X.n_rows;
  const int p = X.n_cols;
  const double h = std::pow((std::log(n) + p) / n, 0.4);
...
// [[Rcpp::export]]
Rcpp::List smqrParaNsd(const arma::mat& X, const arma::vec& Y, const double tau = 0.5, const double constTau = 1.345, const double tol = 0.0000001, 
                       const int iteMax = 5000) {
  const int n = X.n_rows;
  const int p = X.n_cols;
  const double h = std::pow((std::log(n) + p) / n, 0.4);
...
// [[Rcpp::export]]
Rcpp::List smqrTrianNsd(const arma::mat& X, const arma::vec& Y, const double tau = 0.5, const double constTau = 1.345, const double tol = 0.0000001, 
                        const int iteMax = 5000) {
  const int n = X.n_rows;
  const int p = X.n_cols;
  const double h = std::pow((std::log(n) + p) / n, 0.4);
